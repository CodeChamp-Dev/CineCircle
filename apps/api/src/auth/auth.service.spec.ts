...
describe('AuthService', () => {
  ...
  describe('login', () => {
    ...
    it('should login existing user successfully', async () => {
      ...
      jest.spyOn(service as any, 'getMockUser').mockResolvedValue(mockUser);
    ...
    it('should throw UnauthorizedException for non-existent user', async () => {
      ...
      jest.spyOn(service as any, 'getMockUser').mockResolvedValue(null);
    ...
    it('should throw UnauthorizedException for inactive user', async () => {
      ...
      jest.spyOn(service as any, 'getMockUser').mockResolvedValue(inactiveUser);
  ...
  describe('register', () => {
    ...
    it('should throw ConflictException for existing username', async () => {
      ...
      const conflictDto = { ...registerDto, email: 'existinguser@example.com', username: 'existinguser' };
      await expect(service.register(conflictDto)).rejects.toThrow(ConflictException);
    });
  });
  ...
  describe('updateProfile', () => {
    ...
    it('should throw NotFoundException for non-existent user', async () => {
      ...
      await expect(service.updateProfile('non_existent', updateDto)).rejects.toThrow(NotFoundException);
    });
  });
